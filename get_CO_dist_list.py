...
C_O_existed_poscar_folder_path_list = np.load('../get_some_speceis_existed_poscar_path_list/C_O_existed_poscar_folder_path_list.npy', allow_pickle=True)
...
np.save('CO_dist_1d_list.npy', np.array(CO_bond_dist_1d_list))
